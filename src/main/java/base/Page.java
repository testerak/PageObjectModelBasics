...
public class Page {
	// THIS IS OUR SUPER TEST CLASS AND EVERYTHING WE DO IS INITALISED IN THIS CLASS
	// use ctrl+space to import
	//ALSO DIFFERENCE  BETWEEN BASETEST AND PAGE CLASS IS, PAGE CLASS DOES NOT USE TESTNG OR 
	//JUNIT TO RUN TESTCASE USING MAIN METHOD
	...
	//added static quit method for teardown in testng base test
	...
	//*********END LOAD  Config.PROPERTIES AND OR.PROPERTIES  ***********		
	...
	//******END SETUP FILTERS IN JENKINS FOR BROWSER FILTER CONFIGURATION ENVIRONMENT*****			
	...
	// 3 COMMON KEYWORD METHODS ADDED BELOW
//NOTE CODE if (key.endsWith("_XPATH")) MEANS IF LOCATOR ENDS WITH EXAMPLE _XPATH.
		...
		public static void type(String key, String value) {
			...
			log.info("Typing in:  "+key +" Entering Value as : "+value);
		...
		public static void select(String key, String value) {
			...
			log.info("Selecting dropdown element : " + key + " and entered the value as : " + value);
